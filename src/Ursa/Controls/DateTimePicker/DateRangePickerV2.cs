...
public class DateRangePickerV2 : DatePickerBase, IClearControl
{
    ...
    {
        SelectedStartDateProperty.Changed.AddClassHandler<DateRangePickerV2, DateTime?>((picker, _) =>
            picker.OnSelectionChanged());
        SelectedEndDateProperty.Changed.AddClassHandler<DateRangePickerV2, DateTime?>((picker, _) =>
            picker.OnSelectionChanged());
    }
