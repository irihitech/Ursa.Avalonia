...
public class DateTimePickerV2 : DatePickerBase, IClearControl
{
    ...
    public static readonly StyledProperty<DateTime?> SelectedDateProperty =
        AvaloniaProperty.Register<DateTimePickerV2, DateTime?>(
            nameof(SelectedDate), defaultBindingMode: BindingMode.TwoWay);

    public static readonly StyledProperty<string?> PlaceholderTextProperty =
        AvaloniaProperty.Register<DateTimePickerV2, string?>(nameof(PlaceholderText));

    public static readonly StyledProperty<IBrush?> PlaceholderForegroundProperty =
        AvaloniaProperty.Register<DateTimePickerV2, IBrush?>(nameof(PlaceholderForeground));
    ...
    public static readonly StyledProperty<string> PanelFormatProperty =
        AvaloniaProperty.Register<DateTimePickerV2, string>(
            nameof(PanelFormat), "HH mm ss");

    public static readonly StyledProperty<bool> NeedConfirmationProperty =
        AvaloniaProperty.Register<DateTimePickerV2, bool>(
    ...
    static DateTimePickerV2()
    {
        FocusableProperty.OverrideDefaultValue<DateTimePickerV2>(true);
        DisplayFormatProperty.OverrideDefaultValue<DateTimePickerV2>(CultureInfo.InvariantCulture.DateTimeFormat
            .FullDateTimePattern);
        SelectedDateProperty.Changed.AddClassHandler<DateTimePickerV2, DateTime?>((o, e) => o.OnSelectionChanged(e));
    }
