        ...
        MenuItems = new ObservableCollection<MenuItemViewModel>
        {
            ...
            new()
            {
                MenuHeader = "Dialog & Feedbacks", Children = new ObservableCollection<MenuItemViewModel>()
                {
                    ...
                    new() { MenuHeader = "Notification", Key = MenuKeys.MenuKeyNotification, Status = "Updated" },
                    new() { MenuHeader = "PopConfirm", Key = MenuKeys.MenuKeyPopConfirm },
                    new() { MenuHeader = "Toast", Key = MenuKeys.MenuKeyToast, Status = "Updated" },
            ...
            new()
            {
                MenuHeader = "Date & Time", Children = new ObservableCollection<MenuItemViewModel>
                {
                    ...
                    new() { MenuHeader = "Date Only Picker", Key = MenuKeys.MenuKeyDateOnlyPicker, Status = "New" },
                    new() { MenuHeader = "Date Range Picker", Key = MenuKeys.MenuKeyDateRangePicker, Status = "Updated" },
                    new() { MenuHeader = "Date Only Range Picker", Key = MenuKeys.MenuKeyDateOnlyRangePicker, Status = "New" },
                    ...
                    new() { MenuHeader = "Time Only Picker", Key = MenuKeys.MenuKeyTimeOnlyPicker, Status = "New" },
                    new() { MenuHeader = "Time Range Picker", Key = MenuKeys.MenuKeyTimeRangePicker, Status = "New" },
                    new() { MenuHeader = "Time Only Range Picker", Key = MenuKeys.MenuKeyTimeOnlyRangePicker, Status = "New" },
            ...
            new()
            {
                ...
                Children = new ObservableCollection<MenuItemViewModel>
                {
                    ...
                    new() { MenuHeader = "Descriptions", Key = MenuKeys.MenuKeyDescriptions },
