...
namespace Ursa.Demo.Pages.AnchorDemo;

[DocCategory(Category_Key, IsClickable = false, Parent = NavigationAndMenusPage.Category_Key)]
[DocPage(Menu_Header, View = typeof(AnchorDemo))]
public partial class AnchorDemoViewModel : ObservableObject, IPageMetadataProvider
{
    public const string Category_Key = "Anchor";
    public const string Menu_Header = "Menu_Header_Anchor";
    public PageMetadataViewModel PageMetadata { get; set; } = new PageMetadataViewModel()
    {
        ...
        DemoViewUrl = "https://github.com/irihitech/Ursa.Avalonia/blob/main/demo/Ursa.Demo/Pages/AnchorDemo/AnchorDemo.axaml",
        DemoViewModelUrl = "https://github.com/irihitech/Ursa.Avalonia/blob/main/demo/Ursa.Demo/Pages/AnchorDemo/AnchorDemoViewModel.cs",
