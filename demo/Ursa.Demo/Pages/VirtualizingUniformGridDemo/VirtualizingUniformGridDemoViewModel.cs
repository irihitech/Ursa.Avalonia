...
[DocPage(Menu_Header, View = typeof(VirtualizingUniformGridDemo))]
public partial class VirtualizingUniformGridDemoViewModel : ObservableObject, IPageMetadataProvider
{
    public const string Category_Key = "VirtualizingUniformGrid";
    public const string Menu_Header = "Menu_Header_VirtualizingUniformGrid";
    public PageMetadataViewModel PageMetadata { get; set; } = new PageMetadataViewModel()
    {
        ...
        DemoViewUrl = "https://github.com/irihitech/Ursa.Avalonia/blob/main/demo/Ursa.Demo/Pages/VirtualizingUniformGridDemo/VirtualizingUniformGridDemo.axaml",
        DemoViewModelUrl = "https://github.com/irihitech/Ursa.Avalonia/blob/main/demo/Ursa.Demo/Pages/VirtualizingUniformGridDemo/VirtualizingUniformGridDemoViewModel.cs",
