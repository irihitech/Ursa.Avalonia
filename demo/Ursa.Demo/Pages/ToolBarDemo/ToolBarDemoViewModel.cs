...
[DocPage(Menu_Header, View = typeof(ToolBarDemo))]
public partial class ToolBarDemoViewModel : ObservableObject, IPageMetadataProvider
{
    public const string Category_Key = "ToolBar";
    public const string Menu_Header = "Menu_Header_ToolBar";
    public PageMetadataViewModel PageMetadata { get; set; } = new PageMetadataViewModel()
    {
        ...
        DemoViewUrl = "https://github.com/irihitech/Ursa.Avalonia/blob/main/demo/Ursa.Demo/Pages/ToolBarDemo/ToolBarDemo.axaml",
        DemoViewModelUrl = "https://github.com/irihitech/Ursa.Avalonia/blob/main/demo/Ursa.Demo/Pages/ToolBarDemo/ToolBarDemoViewModel.cs",
