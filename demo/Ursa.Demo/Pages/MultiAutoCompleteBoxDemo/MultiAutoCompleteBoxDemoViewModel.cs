...
[DocPage(Menu_Header, View = typeof(MultiAutoCompleteBoxDemo))]
public class MultiAutoCompleteBoxDemoViewModel : ObservableObject, IPageMetadataProvider
{
    ...
    public PageMetadataViewModel PageMetadata { get; set; } = new PageMetadataViewModel()
    {
        ...
        Description = LanguageManager.Instance.Page_Description_MultiAutoCompleteBox,
        Breadcrumbs = [new BreadcrumbItemData(LanguageManager.Instance.Menu_Category_ButtonsAndInputs), new BreadcrumbItemData(LanguageManager.Instance.Menu_Header_MultiAutoCompleteBox)],
        Tags = ["MultiAutoCompleteBox", "AutoComplete", "Input"],
        DemoViewUrl = "https://github.com/irihitech/Ursa.Avalonia/blob/main/demo/Ursa.Demo/Pages/MultiAutoCompleteBoxDemo/MultiAutoCompleteBoxDemo.axaml",
        DemoViewModelUrl = "https://github.com/irihitech/Ursa.Avalonia/blob/main/demo/Ursa.Demo/Pages/MultiAutoCompleteBoxDemo/MultiAutoCompleteBoxDemoViewModel.cs",
