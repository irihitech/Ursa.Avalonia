...
namespace Ursa.Demo.Pages.ElasticWrapPanelDemo;

[DocCategory(Category_Key, IsClickable = false, Parent = LayoutAndDisplayPage.Category_Key)]
[DocPage(Menu_Header, View = typeof(ElasticWrapPanelDemo))]
public partial class ElasticWrapPanelDemoViewModel : ObservableObject, IPageMetadataProvider
{
    public const string Category_Key = "ElasticWrapPanel";
    public const string Menu_Header = "Menu_Header_ElasticWrapPanel";
    public PageMetadataViewModel PageMetadata { get; set; } = new PageMetadataViewModel()
    {
        ...
        DemoViewUrl = "https://github.com/irihitech/Ursa.Avalonia/blob/main/demo/Ursa.Demo/Pages/ElasticWrapPanelDemo/ElasticWrapPanelDemo.axaml",
        DemoViewModelUrl = "https://github.com/irihitech/Ursa.Avalonia/blob/main/demo/Ursa.Demo/Pages/ElasticWrapPanelDemo/ElasticWrapPanelDemoViewModel.cs",
