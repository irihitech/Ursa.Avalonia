...
public class DatePickerCalendarContextTests
{
    [Fact]
    public void Clone_ReturnsExactCopy()
    {
        var context = new DatePickerCalendarContext(2023, 5, 2000, 2030);
    ...
    {
        var today = DatePickerCalendarContext.Today();
    ...
    {
        var context = new DatePickerCalendarContext(2023, 12);
        var nextMonth = context.NextMonth();
    ...
    {
        var context = new DatePickerCalendarContext(2023, 1);
        var previousMonth = context.PreviousMonth();
    ...
    {
        var context1 = new DatePickerCalendarContext(2023, 5);
        var context2 = new DatePickerCalendarContext(2023, 5);
    ...
    {
        var context1 = new DatePickerCalendarContext(2023, 5);
        var context2 = new DatePickerCalendarContext(2024, 5);
    ...
    {
        var context1 = new DatePickerCalendarContext(2023, 5);
        var context2 = new DatePickerCalendarContext(2023, 6);
        Assert.NotEqual(0, context1.CompareTo(context2));
    }
