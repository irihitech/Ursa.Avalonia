...
{
    private static DateTimeOffsetPicker CreatePicker() => new()
    {
        Width = 400,
    ...
    public void Set_SelectedDate_Updates_TextBox()
    {
        ...
        picker.SelectedDate = new DateTimeOffset(new DateTime(2025, 6, 15, 14, 30, 0), TimeSpan.Zero);
        Dispatcher.UIThread.RunJobs();

        var textBox = picker.GetTemplateChildOfType<TextBox>(DateTimePickerBase.PART_TextBox);
        Assert.NotNull(textBox);
        Assert.Equal("2025-06-15 14:30:00", textBox.Text);
    }
    ...
    public void SelectedOffset_Change_Preserves_DateTime_Updates_Offset()
    {
        ...
        picker.SelectedDate = new DateTimeOffset(new DateTime(2025, 6, 15, 9, 0, 0), TimeSpan.Zero);
        Dispatcher.UIThread.RunJobs();
        ...
        Assert.Equal(new DateTime(2025, 6, 15, 9, 0, 0), picker.SelectedDate.Value.DateTime);
    }
    ...
    public void ComboBox_Click_Does_Not_Open_Popup()
    {
        ...
        var comboBox = picker.GetTemplateChildOfType<ComboBox>(DateTimeOffsetPicker.PART_OffsetComboBox);
